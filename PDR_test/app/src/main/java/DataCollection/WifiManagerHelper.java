...
public class WifiManagerHelper{
    ...
    public Handler handlerWifi;
    public TimerTask scanTaskWifi;
    public WifiScanResultHandler wifiScanResultHandler;
    public Timer timerWifi;
    ...
    public float measuredWifiFreq;
    public double lastWifiTimestamp;
    public double timestamp;
    public long initialTimeNs;
    public long timestampNs;
    public StringBuilder wifiCsvData = new StringBuilder();
